...
namespace eShopTruongSport.ApiIntegration.Services
{
    public class ProductApiClient : BaseApiClient, IProductApiClient
    {
        ...
        public async Task<bool> CreateProduct(ProductCreateRequest request)
        {
            ...
            requestContent.Add(new StringContent(request.IsFutured.ToString()), "isFutured");
        ...
        public async Task<bool> UpdateStock(int productId, int newStock)
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", sessions);
            var requestContent = new MultipartFormDataContent();
            requestContent.Add(new StringContent(newStock.ToString()), "newStock");
            var response = await client.PatchAsync($"/api/products/updateStock/"+ productId, requestContent);
            return response.IsSuccessStatusCode;
        }
    }
}
